 ...
 * @author Procislaw
 */
@WebServlet(urlPatterns = {"/Bankietowki"})
public class Bankietowki extends HttpServlet {
    Lista lis;
    String plik;
    MetodyPom metody;
    ...
    public Bankietowki(){
        ...
        this.plik="C:\\Users\\Procislaw\\Desktop\\Sem2\\TAI\\Cukiernia3\\file.xml";
    ...
    private void showTempl(HttpServletRequest request, HttpServletResponse response, String content){
        try (PrintWriter out = response.getWriter()) {
            ...
            Logger.getLogger(Bankietowki.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       request.setCharacterEncoding( "UTF-8" );
        ...
        if (event==null){
            //metody.showData(lis.getLista());
            showTempl(request,response,metody.showData("Bankietówki",lis.getLista(),request.isRequestedSessionIdValid()));
        }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       if (request.getParameterMap().containsKey("zapisz")&&(request.isRequestedSessionIdValid())){
             ...
             tekst = metody.showData("Bankietówki",lis.getLista(),request.isRequestedSessionIdValid());
