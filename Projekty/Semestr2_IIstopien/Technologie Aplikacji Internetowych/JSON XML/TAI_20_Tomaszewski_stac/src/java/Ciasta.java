 ...
 * @author Procislaw
 */
@WebServlet(urlPatterns = {"/Ciasta"})
public class Ciasta extends HttpServlet {
    ...
    private void showTempl(HttpServletRequest request, HttpServletResponse response, String content){
        try (PrintWriter out = response.getWriter()) {
            ...
            Logger.getLogger(Ciasta.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (event==null){
            showTempl(request,response,metody.showData("Ciasta",lis.getLista(),request.isRequestedSessionIdValid()));
        }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       if (request.getParameterMap().containsKey("zapisz")&&(request.isRequestedSessionIdValid())){             
             ...
             tekst = metody.showData("Ciasta",lis.getLista(),request.isRequestedSessionIdValid());   
