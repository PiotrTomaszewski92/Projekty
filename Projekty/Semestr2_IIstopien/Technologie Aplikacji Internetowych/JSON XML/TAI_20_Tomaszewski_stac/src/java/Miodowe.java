 ...
 * @author Procislaw
 */
@WebServlet(urlPatterns = {"/Miodowe"})
public class Miodowe extends HttpServlet {
    ...
    public Miodowe(){
        ...
        this.plik="C:\\Users\\Procislaw\\Desktop\\Sem2\\TAI\\Cukiernia3\\miodowe.xml";
    ...
    private void showTempl(HttpServletRequest request, HttpServletResponse response, String content){
        try (PrintWriter out = response.getWriter()) {
            ...
            Logger.getLogger(Miodowe.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    /**
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (event==null){
            showTempl(request,response,metody.showData("Ciastka miodowe",lis.getLista(),request.isRequestedSessionIdValid()));
        }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       if (request.getParameterMap().containsKey("zapisz")&&(request.isRequestedSessionIdValid())){
             ...
             tekst = metody.showData("Ciastka miodowe",lis.getLista(),request.isRequestedSessionIdValid());
